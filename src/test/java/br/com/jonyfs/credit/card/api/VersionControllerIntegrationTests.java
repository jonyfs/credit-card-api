...
public class VersionControllerIntegrationTests {
	...
	public void test() throws Exception {
		...
		this.mockMvc.perform(get(ResourcePaths.Version.ROOT).accept(MediaType.APPLICATION_JSON)).andDo(print())
				.andDo(document).andExpect(status().isOk()).andExpect((jsonPath("$", notNullValue())));
	}
